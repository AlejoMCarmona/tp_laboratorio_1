...
int getInt(int *numeroInt) { //getInt
	char buffer[64];
	int retorno;
	retorno = 0;
...
int IngresarFlotante(float* numero, char mensaje[]) {//utn_getNumero
	int retorno;
	float bufferFloat;
	retorno = 0;
...
int IngresarFlotanteConIntentos(float* numero, char mensaje[], char mensajeError[], int intentos) {//utn_getNumero
	int retorno;
	float bufferFloat;
	retorno = 0;
...
int getFloat(float *numeroFloat) { //getFloat
	int retorno;
	char buffer[64];
	retorno = 0;
...
int ValidarFlotante(char cadena[]) { //esNumerica
	int i;
	int retorno;
	int contadorPuntos;
	contadorPuntos = 0;
	...
	//flotantes validos: 3.314444; +3.314444; -3.314444; .314444; -.314444; +.314444; -3144444; +3144444; -314444.
	if (cadena != NULL && strlen(cadena) > 0) {
		while (cadena[i] != '\0') {
			if (i == 0 && (cadena[i] == '-' || cadena[i] == '+')) {
				i++;
